...
Typed knative-serving resources for the Cloudcoil Kubernetes client.

[![PyPI](https://img.shields.io/pypi/v/cloudcoil.models.knative_serving.svg)](https://pypi.org/project/cloudcoil.models.knative_serving/)
...
```sh
uv add cloudcoil.models.knative_serving
# Or:
pip install cloudcoil.models.knative_serving
```
